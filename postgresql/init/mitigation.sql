...
RETURNS void
AS $$
    INSERT INTO risky_public.mitigation(name, description, business_id, action_id, implemented) values(fn_name, fn_description, fn_business_id, fn_action_id, fn_implemented);
$$ LANGUAGE sql VOLATILE;
