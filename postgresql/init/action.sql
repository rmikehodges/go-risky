...
CREATE OR REPLACE FUNCTION risky_public.actions(fn_business_id uuid) 
...
CREATE OR REPLACE FUNCTION risky_public.get_action(fn_action_id uuid) 
...
CREATE OR REPLACE FUNCTION risky_public.delete_action(fn_action_id uuid) 
RETURNS void 
AS $$
...
CREATE OR REPLACE FUNCTION risky_public.create_action(fn_name varchar, fn_description varchar, fn_capability_id uuid, fn_vulnerability_id uuid, fn_business_id uuid, fn_complexity risky_public.action_complexity, fn_asset_id uuid) 
RETURNS void
AS $$
...
CREATE OR REPLACE FUNCTION risky_public.update_action(fn_action_id uuid,fn_name varchar, fn_description varchar, fn_capability_id uuid, fn_vulnerability_id uuid, fn_business_id uuid, fn_complexity risky_public.action_complexity, fn_asset_id uuid) 
RETURNS void 
AS $$
