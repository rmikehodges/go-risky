...
RETURNS void
AS $$
    INSERT INTO risky_public.resource(name, cost, unit, total, resouce_type, business_id)  values(fn_name, fn_cost, fn_unit, fn_total, fn_resouce_type, fn_business_id);
$$ LANGUAGE sql VOLATILE;
