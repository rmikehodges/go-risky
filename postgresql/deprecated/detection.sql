...
RETURNS uuid
AS $$
    INSERT INTO risky_public.detection(name, description, business_id, action_id, implemented) values(fn_name, fn_description, fn_business_id, fn_action_id, fn_implemented) RETURNING id;
$$ LANGUAGE sql VOLATILE;
